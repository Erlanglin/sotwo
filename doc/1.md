...
8. 采用Maven命令运行本项目的sotwo-admin-api模块。
   ...
   如果采用IDEA，则sotwo-admin-api模块的Application类
   右键` Run Application.main()`方式运行该模块,
...
打开浏览器，输入以下地址：
```
http://www.bill.myoranges.cn/os/index/index
http://www.bill.myoranges.cn/wx/index/index
http://www.bill.myoranges.cn/admin/index/index
```
